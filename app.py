...
# Replace st.number_input label
days = st.number_input('Days', min_value=1, max_value=10000, value=1)
period = int(days)
...
tab1, tab2, tab3 = st.tabs(['Prediction result', 'Forecasted plot', 'Forecasting components'])
